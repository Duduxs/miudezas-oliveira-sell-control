...
public class DaoFactory {
	...
	// Here i return a ItemSellDAO after opening a connection with at the DB.
	public static ItemSellDAO createItemSellDAO() {
		return new ItemSellDAO(DB.openConnection());
	}
}
